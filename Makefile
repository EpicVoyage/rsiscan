...
SOURCE=lib/config.o lib/rsiscript.o lib/http.o lib/comma_separated_values.o lib/stock.o lib/stats/relative_strength_index.o lib/stats/bollinger.o lib/stats/simple_moving_average.o lib/stats/moving_average_convergence_divergence.o lib/stats/exponential_moving_average.o lib/stats/high.o lib/stats/low.o
TESTS=tests/main.o tests/lib/rsiscript.o tests/lib/http.o tests/lib/comma_separated_values.o tests/lib/stock.o
